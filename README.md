## Utilizing some classic non-parametric tests, I performed statistical analysis on two simulated datasets of a Computer Game Company (let's call it WSG) to support their strategy based on player behaviour.
